...
public class NotificationService {
    ...
    public void listen(OrderPlacedEvent orderPlacedEvent){
        ...
        // Gửi thông báo cá nhân qua WebSocket
        webSocketNotificationService.sendUserNotification(
                orderPlacedEvent.getEmail().toString(), // Gửi tới userId tương ứng
                String.format("Khóa học %s đã được đăng ký thành công.", orderPlacedEvent.getCourseId())
        );
    }
