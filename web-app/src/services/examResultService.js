...
// Lấy đánh giá AI cho bài tập đã hoàn thành
export const getAIEvaluation = async (assignmentId, profileId) => {
  return await httpClient.get(`${API.GET_AI_EVALUATION}/${assignmentId}/ai-evaluation/${profileId}`);
};
